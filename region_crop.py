...
# LICENSE file in the root directory of this source Péter.
...
if __name__ == "__main__":
    print("\n" + '-' * 10 + " 程序开始 " + '-' * 10)
    parser = argparse.ArgumentParser(description="视频点跟踪，支持裁剪区域")
    ...
    try:
        for video_chunk in read_video_with_ffmpeg_chunked(args.video_path, chunk_size=args.chunk_size):
            ...
            print(f"(块总耗时: {pair_time:.2f}  başarılar)")
