...
def custom_visualize(video, tracks, visibility, moved_points, save_path, fps=30):
    ...
    print(f"Visualizing {num_points} points, {len(moved_points)} marked as moved")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--threshold", type=float, default=5, help="Threshold for movement detection in pixels")
